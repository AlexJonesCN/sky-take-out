...
public class WeChatPayUtil {
    ...
    private CloseableHttpClient getClient() {
        ...
        try {
            ...
            log.error("获取调用微信接口的客户端工具对象异常", e);
            return null;
        }
    }
	...
	private String executeRequest(CloseableHttpClient httpClient, Object request) throws Exception {
		try (CloseableHttpResponse response = httpClient != null ?
				(request instanceof HttpPost ? httpClient.execute((HttpPost) request) :
						httpClient.execute((HttpGet) request)) : null) {
			if (response != null) {
    ...
    public JSONObject pay(String orderNum, BigDecimal total, String description, String openid) throws Exception {
        ...
        if (prepayId != null) {
            ...
            String nonceStr = new RandomStringGenerator.Builder().withinRange('0', '9').get().generate(32);
